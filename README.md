...
This repository hosts the Foundry VTT `Dockerfile` for [lichtobergo/fvtt-docker](https://hub.docker.com/r/lichtobergo/fvtt-docker). This is a fork from [Benjamins Price's](https://github.com/BenjaminPrice/fvtt-docker) github repo. The `Dockerfile` was changed to use Nodejs version 18 to be compatible with FoundryVTT Version 11.
